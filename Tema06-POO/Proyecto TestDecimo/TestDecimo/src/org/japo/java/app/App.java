...
public class App {
    ...
    public void lanzarAplicacion() {
        ...
        System.out.println();
        System.out.println("Objeto 1 Duplicado : Pongo valores dentro del rango correcto.");
        // Objeto 1 : Pongo valores dentro del rango correcto.
        Decimo d1BIS = new Decimo();
        d1BIS.setNumero(45);
        d1BIS.setSerie(26);
        d1BIS.setFraccion(8);
        d1BIS.mostrarDecimo();
        ...
        System.out.println();
        // Comparativa de d1 con d2 : Dos objetos distintos.
        System.out.println(d1.equals(d2));

        System.out.println();
        // Comparativa de d1 con d1BIS : Dos objetos iguales.
        System.out.println(d1.equals(d1BIS));
    }
