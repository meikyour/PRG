...
public class Decimo implements Serializable, IDecimo {
    ...
    public boolean equals(Object obj) {
        ...
        if (testOK) {
            Decimo d = (Decimo) obj;
            testOK = this.numero == numero && this.serie == serie && this.fraccion == fraccion;
        }
        return testOK;
    }
    ...
    public static boolean validarDecimo(int numero, int serie, int fraccion) {
        ...
        boolean decimoOK;
        return decimoOK = numero >= NUMERO_MIN && numero <= NUMERO_MAX && serie >= SERIE_MIN && serie <= SERIE_MAX && fraccion >= FRACCION_MIN && fraccion <= FRACCION_MAX;
    }
